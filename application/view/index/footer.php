                ...
                <div class="footer_content">
                    <div class="span4 col-xm-12">
                        <div class="footer_list">
                            <div class="span6">
                                <div class="bottom_logo"> <img src="__IMG__/weixin.png" alt="微信服务号二维码" /> </div>
                            </div>
                            <div class="span6 col-xm-12">
                                <div class="quick_navigation">
                                    <div class="quick_navigation_title">快速导航</div>
                                    <ul>
                                        <li><a href="index"  class='active'  title="首页">首&nbsp;&nbsp;页</a></li>
                                        <li><a href="about_us" title="关于我们">关于我们</a></li>
                                        <li><a href="solution" title="作品展示">作品展示</a></li>
                                        <li><a href="course" title="课程定制">课程介绍</a></li>
                                        <li><a href="teacher" title="精英师资">精英师资</a></li>
                        ...
                        <div class="footer_list">
                            <div class="footer_link">
                                ...
                                <ul id="frientLinks">
                                    ...
                                    <li><a href='index' target='_blank'>厚学网</a> </li>
